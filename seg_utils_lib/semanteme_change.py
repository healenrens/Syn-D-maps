...
def semanteme_change(input_data_: Dict[str, List[List[List[float]]]], max_changes: float):
    ...
    for group_index in group_indices:
        ...
        _tmp = this_group_boundary
        group['road_boundary'] = group['lane_divider'] + group['road_divider']
        group['lane_divider'] = _tmp
